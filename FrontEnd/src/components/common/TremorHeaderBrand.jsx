...
export default function TremorHeaderBrand({
  ...
  return (
    <div className={`flex items-center gap-3 select-none ${className}`}>
      ...
      {subtitle && (
        <span className="hidden sm:inline-block rounded-md border border-[#152326] bg-black px-2 py-0.5 font-mono-tech text-[9px] uppercase tracking-wider text-[#8a9992]">
          {subtitle}
        </span>
      )}
    </div>
